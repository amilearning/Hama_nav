...
class MPPI():
    ...
    def __init__(self, dynamics, running_cost, nx, noise_sigma, num_samples=100, horizon=15, device="cuda",
    ...
    @handle_batch_input
    def _running_cost(self, state, u, t,prev_state):
        return self.running_cost(state, u, t,prev_state)
    ...
    def _compute_rollout_costs(self, perturbed_actions):
        ...
        for t in range(T):
            ...
            c = self._running_cost(state, u, t, prev_state)
            cost_samples += c
            if self.M > 1:
